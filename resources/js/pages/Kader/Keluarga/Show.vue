...
<template>
    ...
    <AppLayout>
        ...
        <SidaConfirm
            :show="confirmAnggotaId !== null"
            :message="`Hapus data anggota '${confirmAnggotaName}'?`"
            @confirm="doDeleteAnggota"
            @cancel="confirmAnggotaId = null"
        />

        <!-- Back button -->
        <a href="/kader/keluarga" class="mb-5 inline-flex items-center gap-2 text-sm font-medium text-gray-500 transition hover:text-emerald-600">
            ...
            <div class="overflow-hidden rounded-2xl shadow-sm ring-1 ring-gray-200">
                ...
                <div class="bg-gradient-to-r from-emerald-600 to-teal-600 px-6 py-5">
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <span :class="statusBadge(keluarga.verifikasi?.status_verifikasi ?? 'menunggu')" class="shrink-0 rounded-full px-3 py-1 text-xs font-semibold capitalize">
                ...
                <div class="bg-white px-6 py-4">
                    <div class="grid grid-cols-2 gap-4 text-sm sm:grid-cols-4">
                        <div>
                            <p class="text-xs font-medium text-gray-400 uppercase tracking-wide">Dasawisma</p>
                            <p class="mt-0.5 font-semibold text-gray-700">{{ keluarga.dasawisma?.nama_dasawisma ?? '-' }}</p>
                        </div>
                        <div>
                            <p class="text-xs font-medium text-gray-400 uppercase tracking-wide">RT/RW</p>
                            <p class="mt-0.5 font-semibold text-gray-700">{{ keluarga.dasawisma?.rt }}/{{ keluarga.dasawisma?.rw }}</p>
                        </div>
                        <div>
                            <p class="text-xs font-medium text-gray-400 uppercase tracking-wide">Jumlah Anggota</p>
                            <p class="mt-0.5 font-semibold text-gray-700">{{ keluarga.anggota_keluargas?.length ?? 0 }} jiwa</p>
                        </div>
                    ...
                    <table class="w-full text-sm whitespace-nowrap">
                        <thead>
                            <tr class="border-b border-gray-100 bg-gray-50/50">
                                <th class="px-5 py-3 text-left text-[11px] font-semibold uppercase tracking-wide text-gray-400">#</th>
                                <th class="px-5 py-3 text-left text-[11px] font-semibold uppercase tracking-wide text-gray-400">NIK</th>
                                <th class="px-5 py-3 text-left text-[11px] font-semibold uppercase tracking-wide text-gray-400">Nama</th>
                                <th class="px-5 py-3 text-left text-[11px] font-semibold uppercase tracking-wide text-gray-400">L/P</th>
                                <th class="px-5 py-3 text-left text-[11px] font-semibold uppercase tracking-wide text-gray-400">Tgl Lahir</th>
                                <th class="px-5 py-3 text-left text-[11px] font-semibold uppercase tracking-wide text-gray-400">Status KK</th>
                                <th class="px-5 py-3 text-left text-[11px] font-semibold uppercase tracking-wide text-gray-400">Pekerjaan</th>
                                <th class="px-5 py-3 text-center text-[11px] font-semibold uppercase tracking-wide text-gray-400">Aksi</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-50">
                            <tr v-for="(ak, idx) in keluarga.anggota_keluargas" :key="ak.id" class="group transition hover:bg-gray-50/60">
                                ...
                                <td class="px-5 py-3.5">
                                    <span :class="ak.jenis_kelamin === 'L' ? 'bg-blue-50 text-blue-600' : 'bg-pink-50 text-pink-600'" class="rounded-full px-2 py-0.5 text-[11px] font-semibold">
        ...
        <!-- ====== MODAL EDIT ANGGOTA ====== -->
        <SidaModal :show="showEditAnggota" title="Edit Data Anggota" max-width="max-w-2xl" @close="showEditAnggota = false">
            <form @submit.prevent="submitEditAnggota" class="space-y-4">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input v-model="editAnggotaForm.nik" type="text" maxlength="16" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 font-mono text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition" />
                    ...
                    <div>
                        ...
                        <input v-model="editAnggotaForm.nama_anggota" type="text" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition" />
                    ...
                    <div>
                        ...
                        <select v-model="editAnggotaForm.jenis_kelamin" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition">
                    ...
                    <div>
                        ...
                        <input v-model="editAnggotaForm.tanggal_lahir" type="date" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition" />
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold text-gray-600">Agama</label>
                        <select v-model="editAnggotaForm.agama" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition">
                    ...
                    <div>
                        ...
                        <select v-model="editAnggotaForm.pendidikan" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition">
                            <option value="">-- Pilih --</option>
                    ...
                    <div>
                        ...
                        <select v-model="editAnggotaForm.pekerjaan" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition">
                            <option value="">-- Pilih --</option>
                    ...
                    <div>
                        ...
                        <select v-model="editAnggotaForm.status_dalam_keluarga" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition">
                            <option value="">-- Pilih --</option>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select v-model="editAnggotaForm.status_perkawinan" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition">
                            <option value="">-- Pilih --</option>
                ...
                <div class="flex justify-end gap-3 border-t border-gray-100 pt-4">
                    <button type="button" @click="showEditAnggota = false" class="rounded-xl border border-gray-200 px-5 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-50 transition">Batal</button>
                    <button type="submit" :disabled="editAnggotaForm.processing" class="rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-emerald-700 disabled:opacity-60 transition">
        ...
        <SidaModal :show="showTambahAnggota" title="Tambah Anggota Keluarga" max-width="max-w-2xl" @close="showTambahAnggota = false">
            <form @submit.prevent="submitTambahAnggota" class="space-y-4">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        <label class="mb-1 block text-xs font-semibold text-gray-600">NIK (16 digit) *</label>
                        <input v-model="tambahForm.nik" type="text" maxlength="16" placeholder="16 digit NIK" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 font-mono text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition" />
                        <p v-if="tambahForm.errors.nik" class="mt-1 text-xs text-red-500">{{ tambahForm.errors.nik }}</p>
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold text-gray-600">Nama Lengkap *</label>
                        <input v-model="tambahForm.nama_anggota" type="text" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition" />
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold text-gray-600">Jenis Kelamin *</label>
                        <select v-model="tambahForm.jenis_kelamin" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition">
                            <option value="L">Laki-laki</option>
                            <option value="P">Perempuan</option>
                        </select>
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold text-gray-600">Tanggal Lahir *</label>
                        <input v-model="tambahForm.tanggal_lahir" type="date" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition" />
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold text-gray-600">Agama</label>
                        <select v-model="tambahForm.agama" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition">
                            <option value="">-- Pilih --</option>
                            <option v-for="a in agamaOptions" :key="a" :value="a">{{ a }}</option>
                        </select>
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold text-gray-600">Pendidikan</label>
                        <select v-model="tambahForm.pendidikan" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition">
                            <option value="">-- Pilih --</option>
                            <option v-for="p in pendidikanOptions" :key="p" :value="p">{{ p }}</option>
                        </select>
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold text-gray-600">Pekerjaan</label>
                        <select v-model="tambahForm.pekerjaan" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition">
                            <option value="">-- Pilih --</option>
                            <option v-for="pk in pekerjaanOptions" :key="pk" :value="pk">{{ pk }}</option>
                        </select>
                    </div>
                    <div>
                        <label class="mb-1 block text-xs font-semibold text-gray-600">Status dalam Keluarga</label>
                        <select v-model="tambahForm.status_dalam_keluarga" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition">
                            <option value="">-- Pilih --</option>
                            <option v-for="s in statusKKOptions" :key="s" :value="s">{{ s }}</option>
                        </select>
                    </div>
                    <div class="sm:col-span-2">
                        <label class="mb-1 block text-xs font-semibold text-gray-600">Status Perkawinan</label>
                        <select v-model="tambahForm.status_perkawinan" class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 transition">
                            <option value="">-- Pilih --</option>
                            <option v-for="sk in statusKawinOptions" :key="sk" :value="sk">{{ sk }}</option>
                        </select>
                    </div>
                ...
                <div class="flex justify-end gap-3 border-t border-gray-100 pt-4">
                    <button type="button" @click="showTambahAnggota = false" class="rounded-xl border border-gray-200 px-5 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-50 transition">Batal</button>
                    <button type="submit" :disabled="tambahForm.processing" class="rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-emerald-700 disabled:opacity-60 transition">
