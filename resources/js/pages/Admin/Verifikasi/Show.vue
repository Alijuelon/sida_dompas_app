        ...
        <div class="mx-auto max-w-5xl flex flex-col gap-5">
            ...
            <div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-3">
                    ...
                    <div class="rounded-xl bg-orange-50 p-3 text-center"><p class="text-[10px] text-orange-500 uppercase font-bold">Balita</p><p class="text-lg font-black text-orange-700">{{ kk?.jumlah_balita ?? 0 }}</p></div>
                    <div class="rounded-xl bg-sky-50 p-3 text-center"><p class="text-[10px] text-sky-500 uppercase font-bold">Balita L</p><p class="text-lg font-black text-sky-700">{{ kk?.jumlah_balita_laki ?? 0 }}</p></div>
                    <div class="rounded-xl bg-pink-50 p-3 text-center"><p class="text-[10px] text-pink-500 uppercase font-bold">Balita P</p><p class="text-lg font-black text-pink-700">{{ kk?.jumlah_balita_perempuan ?? 0 }}</p></div>
